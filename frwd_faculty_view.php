...
?>
  ...
  <div class="container-fluid">
          ...
          <div class="col-md-12">
          <center>
                <form action="success_frwd.php" method="post" autocomplete="off">
                          <div class="form_details">
                            <div class="sub-button">
                              <input type="submit" name="update" value="Forward to Dean">
                            </div>
                          </div>
                        </form>
                          <form action="user3_hod_email.php" method="post" autocomplete="off">
                          <div class="form_details">
                            <div class="sub-button">
