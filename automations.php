...
echo '<script>window.alert("Are you sure you want to do a new automation?\nThis will delete the present automated data from the database!")</script>';
$mysqli->query("DELETE from automate");
$mysqli->query("UPDATE faculty set assign=0");
$branch;
...
$result1=$mysqli->query("SELECT * from clg_list");
 ...
 echo '<script>
                window.location.href="automations1.php";
    </script>';
?>