...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-xs-6">
    <center>
      <form action="faculty_profile.php" method="post"  autocomplete="off">
...
<?php
$result=$mysqli->query("SELECT * from automate where ext_faculty='$email'");
