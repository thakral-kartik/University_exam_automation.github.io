...
<div class="contact">
     ...
     <div class="contact_top">                  
            <div class="col-md-3">
             ...
             <div class="col-md-7">
                    <h4>Internal Faculty</h4>
                        <center>

<form action="internal1.php" method="post" autocomplete="off">
<table class="table table-hover">
    ...
    <tbody>
      <tr>
       <td><label> EXTERNAL FULL NAME</label></td>
       <td><input type="text" required autocomplete="off" name="external_name"></td>
      </tr>
      <tr>
       <td><label> EXTERNAL COLLEGE NAME</label></td>
       <td><input type="text" required autocomplete="off" name="clgname"></td>
      </tr>
      <tr>
       <td><label>EXTERNAL COLLEGE CODE</label></td>
       <td><input type="text" required autocomplete="off" name="clgcode"></td>
      </tr>
      <tr>
       <td><label> EXAMINER BRANCH</label></td>
       <td><select name="examiner_branch">
    ...
    <option value="electrical">ELECTRICAL</option>
      ...
      <tr>
       <td><label> ASSIGNED PAPER BRANCH</label></td>
       <td><select name="paper_branch">
    <option value="computer science">COMPUTER SCIENCE</option>
    <option value="information technology">INFORMATION TECHONOLOGY</option>
    <option value="civil">CIVIL</option>
    <option value="mechanical">MECHANICAL</option>
    <option value="electrical">ELECTRICAL</option>
      ...
      <tr>
       ...
       <td><input type="text" required autocomplete="off" name="feedback"></td>
      </tr>
      </tbody>
      </table>      	
